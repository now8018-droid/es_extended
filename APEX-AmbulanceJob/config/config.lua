...
Config.Locale = 'th'
Config.DeathUIDelay               = 0 * second -- ดีเลย์ก่อนแสดง UI เมื่อตาย
...
Config.DynamicEarlyRespawnTimer = {
    ...
    ems = {
        oneEmsMinutes = 0.1,    -- หมอ: มีหมอออนไลน์ 1 คน
...
Config.ReviveDistance = 4.0 -- ระยะตรวจสอบฝั่งเซิร์ฟเวอร์ก่อนชุบ/ฉีดยา

-- ระบบขายรถ/ฮอของ resource นี้ยังไม่ได้เปิดใช้งานจริง จึงตั้งค่าเป็นตารางว่างไว้ให้ตรงกับโค้ดปัจจุบัน
